...
const (
	...
	SettingNameBasicHeader          = "basicHeader" // Removed from UI since v1.1.0 caused by issue 54 (https://pipe/issues/54)
...
const (
	...
	SettingBasicHeaderDefault           = "<!-- https://pipe/issues/54 -->"
	SettingBasicBasicNoticeBoardDefault = "<!-- 支持 Markdown -->本博客由 [Pipe](https://pipe) 强力驱动"
)
